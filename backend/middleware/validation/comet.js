...
import Joi from "joi";
import validation from "./base.js"
...
const validatePostComet = validation(postPutSchema);
const validatePutComet = validation(postPutSchema);
const validatePatchComet = validation(patchSchema);

export { validatePostComet, validatePutComet, validatePatchComet };
