...
const validatePostSatellite = validator(postPutSchema) 
const validatePutSatellite = validator(postPutSchema)
const validatePatchSatellite = validator(patchSchema)

export { validatePostSatellite, validatePutSatellite, validatePatchSatellite };
