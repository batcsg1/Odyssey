...
describe("Constellations", () => {
    ...
    it("should paginate for 2 constellations", async () => {
        const res = await chai
            .request(app)
            .get("/api/v1.2/constellations?page=1&amount=2")
            .set("Authorization", `Bearer ${token}`);
    ...
    it("should retrieve a constellation by ID", async () => {
        const res = await chai
            .request(app)
            .get(`/api/v1.2/constellations/${constellationId}`)
            .set("Authorization", `Bearer ${token}`);
    ...
    it("should filter constellations by name", async () => {
        const res = await chai
            .request(app)
            .get("/api/v1.2/constellations?name=Canis Majora")
            .set("Authorization", `Bearer ${token}`);
    ...
    it("should sort constellations by name", async () => {
        const res = await chai
            .request(app)
            .get("/api/v1.2/constellations?sortBy=name")
            .set("Authorization", `Bearer ${token}`);
    ...
    it("should reject non-numeric area during update", async () => {
        const res = await chai
            .request(app)
            .put(`/api/v1.2/constellations/${constellationId}`)
            .set("Authorization", `Bearer ${token}`)
            .send({
                name: "Canis Majora",
                shape: "Bull",
    ...
    it("should delete a constellation by ID", async () => {
        const res = await chai
            .request(app)
            .delete(`/api/v1.2/constellations/${constellationId}`)
            .set("Authorization", `Bearer ${token}`);
