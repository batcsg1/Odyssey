...
const validatePostMeteorShower = validator(postPutSchema, { convert: true });
const validatePutMeteorShower = validator(postPutSchema, { convert: true } );
const validatePatchMeteorShower = validator(patchSchema, { convert: true });

export { validatePostMeteorShower, validatePutMeteorShower, validatePatchMeteorShower };
