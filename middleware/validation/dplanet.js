...
const dwarfPlanetSchema = Joi.object({
...
const validatePostDwarfPlanet = validateSchema(dwarfPlanetSchema, true);
const validatePutDwarfPlanet = validateSchema(dwarfPlanetSchema);

export { validatePostDwarfPlanet, validatePutDwarfPlanet };
