...
describe("Stars", () => {
    ...
    it("should reject non-numeric diameter", async () => {
        const res = await chai
            .request(app)
            .post("/api/v1/planets")
            .send({
    ...
    it("should filter stars by name", async () => {
        const res = await chai
            .request(app)
            .get("/api/v1/planets?name=Sirius");
    ...
    it("should filter stars by type", async () => {
        const res = await chai
            .request(app)
            .get("/api/v1/planets?type=MAIN_SEQUENCE");
