...
describe("Planets", () => {
    ...
    it("should paginate for 2 planets", async () => {
        const res = await chai
            .request(app)
            .get("/api/v1.2/planets?page=1&amount=2")
            .set("Authorization", `Bearer ${token}`);
    ...
    it("should filter planets by name", async () => {
        const res = await chai
            .request(app)
            .get("/api/v1.2/planets?name=Mercury")
            .set("Authorization", `Bearer ${token}`);
    ...
    it("should filter planets by type", async () => {
        const res = await chai
            .request(app)
            .get("/api/v1.2/planets?type=TERRESTIAL")
            .set("Authorization", `Bearer ${token}`);
    ...
    it("should sort planets by name", async () => {
        const res = await chai
            .request(app)
            .get("/api/v1.2/planets?sortBy=name")
            .set("Authorization", `Bearer ${token}`);
    ...
    it("should update one planet field", async () => {
        const res = await chai
            .request(app)
            .patch(`/api/v1.2/planets/${planetId}`)
            .set("Authorization", `Bearer ${token}`)
            .send({
                name: "Venus"
            });
    ...
    it("should delete a planet by ID", async () => {
        const res = await chai
            .request(app)
            .delete(`/api/v1.2/planets/${planetId}`)
            .set("Authorization", `Bearer ${token}`);
